...
This paper briefly dips its toe into many different aspects of class, incorporating both observation and theory, and discussing different scales, from molecular clouds to young stellar objects, to T Tauri disks.
...
This is related to the lecture on gravitational collapse of molecular clouds.
...
This related to our class dicussion on protoplanetary disks.
...
[(Kratter et. al, 2016)](https://www.annualreviews.org/content/journals/10.1146/annurev-astro-081915-023307) *Gravitational Instabilities in Circumstellar Disks*
...
This paper is related to scale heighth in disks.
...
[(Deharveng et al., 2010)](https://ui.adsabs.harvard.edu/abs/2010A%26A...523A...6D/abstract) A gallery of bubbles. The nature of the bubbles observed by Spitzer and what ATLASGAL tells us about the surrounding neutral material
...
This paper is a review on gaseous nebulae and how to determine their abundances and contribution to stellar, galactic, and cosmic evolution. It includes a list of historical resources on HII regions, among other topics, and a discussion of physical processes within them (photoionization/recombination, heating/cooling, emission mechanisms); beyond that is a tutorial in calculating abundances. I used this resource mainly to understand the radiation emitted by HII regions and detected by observers. This paper was helpful in reviewing the activity within HII regions and their basic structure (Stromgren radius calculation) and understanding why observers would choose to look at these objects at a given wavelength to extract information about them.

[(Churchwell, 2002)]( https://ui.adsabs.harvard.edu/abs/2002ARA%26A..40...27C/abstract) Ultra-Compact HII Regions and Massive Star Formation

This paper provides a review on ultra-compact (UC) HII regions, which are small-scale ionized regions around new massive stars still embedded in their natal clouds. These regions are important in the study of massive star formation as they represent a key stage in their development and act as probes of global properties of the Galaxy since they can be detected throughout. The paper details the properties, evolution, and distribution of these regions, from their birth within clumps and cores of molecular clouds, to their morphological types and corresponding histories, to how they can help diagnose electron densities and metallicites around the Milky Way. The author also discusses which theoretical models of massive star formation best match which observed properties of these regions and discuses which improvements and new facilities are needed to better constrain models. This paper is helpful in understanding the early stages of evolution of massive stars, which seem to play a significant role in the cycle of massive star formation.

 [(Liu & Ormel, 2018)]( https://ui.adsabs.harvard.edu/abs/2018A%26A...615A.138L/abstract) Catching drifting pebbles. I. Enhanced pebble accretion efficiencies for eccentric planets

In this paper the authors investigate the efficiency of the pebble accretion mechanism for planet growth through 2D numerical integration, finding that the efficiency is a function of planet eccentricity with those having moderate eccentricities accreting pebbles at higher rates. From their simulations they derive an analytic expression for efficiency which includes planet eccentricity and mass ratio with its star, disk headwind, and aerodynamic pebble size; efficiency increases with mass ratio and decreases with headwind and pebble size. They also find that embryos in resonance and orbiting eccentrically grow faster than those orbiting circularly, causing planets to form preferentially in resonances with the first giant planet. This is an interesting paper incorporating many concepts we’ve discussed about planet growth specifically exploring the pebble accretion model, though in reality this is a 3D process. They’ve assumed that all pebbles are in the midplane and ignored the effect of turbulence potentially lifting pebbles outward; they also do not account for inclination effects in this work. I found this paper to be helpful in wrapping my head around effects to account for within pebble accretion models and helpful in solidifying ideas about resonance discussed in class.

[(Crespi et al, 2024)] ( https://ui.adsabs.harvard.edu/abs/2024A%26A...685A..86C/abstract) Protoplanet collisions: new scaling laws from SPH simulations

In this paper the authors are checking the commonly used scaling laws that describe the outcome of protoplanetary collisions developed by Leinhardt & Steward (2012), specifically focusing on collisions between gravity-dominated bodies. They use a few ten thousand SPH simulations to review these laws and found that they underestimate the mass of the largest remnant in the accretion regime, as well as overpredict the amount of debris production. The authors develop a new analytical scaling law to predict largest remnants of collisions with a prediction efficiency confirmed by machine learning tests, and are able to reproduce the observed dependence on mass ratio between colliders. I found this paper interesting in that it broke down the different outcome regimes in protoplanetary collisions. This kind of study is important in that we need to have accurate predictions about the remnants of collisions in order to understand planetary accretion, a few models of which we’ve studied in class.

[(Birnstiel 2023)] ( https://ui.adsabs.harvard.edu/abs/2023arXiv231213287B/abstract) Dust growth and evolution in protoplanetary disks

This is a comprehensive review paper on dust growth in protoplanetary disks which covers concepts such as dust accretion through radial drift and other transport processes, the role and thresholds of turbulence and collision in dust growth, dust traps, and more. The author discusses the forces involved in dust dynamics as well as particle size distributions and growth toward planetesimals. This review is good for understanding broadly the processes and timescales involved in dust growth and transport, which is necessary for understanding early stages of planet formation, and also observational tracers. We’ve discussed in class concepts such as bouncing, fragmentation, and radial drift and the limits they impose on growth, and this review does a good job of summarizing the channels that circumvent these limits and fleshing out the topics we touched on.

[(Johnston et al, 2024)] ( https://ui.adsabs.harvard.edu/abs/2024MNRAS.527.2303J/abstract) Formation of giant planets around intermediate-mass stars

This paper focuses on modeling pebble accretion to find the trends associated with the formation of giant planets around stars close to solar mass. This is an important topic to investigate as giant planets seem to play a significant role in shaping the structure of their home systems and giant planets are found around a large percentage of stars. The authors find that giant planets tend to form in disks with large initial size, high metallicity, and high accretion rate, with favored formation at a distance with slow migration and rapid disk dissipation. The giant planets form a few tens of AU out and then migrate inward. The authors do not find any significant effect of proximity to the “snow” line. They acknowledge that certain model parameters such as accretion rate, pre-main sequence luminosity, and metallicity need to be more realistically dependent on stellar mass in order to reproduce the peak of observed rates of giant planet formation around stars of 1.68-1.9 solar mass. I found this paper interesting as it builds upon our class discussion of giant planet formation and discuss the preferential formation of these planets around certain stars.

[(Peltonen et al, 2024)] ( https://ui.adsabs.harvard.edu/abs/2024MNRAS.52710668P/abstract) JWST reveals star formation across a spiral arm in M33

In this paper the authors use JWST MIRI and near-IR PHATTER observations to get a catalogue of infrared point sources in M33 and identify 793 potential massive YSOs from these point sources using color cuts. They find that more massive GMCs host more YSOs according to a power-law slope of 0.67 similar to Milky Way GMCs (0.8) and also contain almost a directly proportional amount of YSOC flux with a power-law slope (0.9). They see that star formation becomes more efficient by a factor of > 30 across M33’s flocculent spiral arm. They plan to test completeness of their sources in the future as well as mass and age estimates with which they plan to make more direct estimates of star formation rates. The authors are trying to determine whether spiral arms concentrate star formation and do find an enhancement which does not seem to come from increasing GMC mass; their efficiency results, however, are dependent on the model they use for the gas/spiral arm. This paper is interesting in that it showcases how JWST has pushed YSO studies further into the Local Group.
